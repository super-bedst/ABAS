...
CREATE TABLE IF NOT EXISTS users (
    ...
    montor_scoped_access TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS bas_user_links (
    ...
    bas_oidc_sub VARCHAR(64) NULL,
    scim_id VARCHAR(64) NULL,
    PRIMARY KEY (aba_user_id),
    UNIQUE KEY uq_bas_username (bas_username),
    UNIQUE KEY uq_bas_oidc_sub (bas_oidc_sub),
    UNIQUE KEY uq_scim_id (scim_id),
