...
<header class="bg-white border-b border-gray-200 shadow-sm">
    <div class="max-w-4xl mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-3">
        <a href="<?= abas_url('register.php') ?>" class="flex items-center gap-3 no-underline text-inherit">
        ...
        <nav class="flex flex-wrap items-center gap-2 text-sm">
            <a href="<?= abas_url('register.php') ?>" class="text-gray-600 hover:text-brand px-2 py-1">Forside</a>
